...
// ─── Sidebar ──────────────────────────────────────────────────────────────────
const navItems = [
  { icon: AlignJustify, label: "Quiz Builder", href: "/quiz-builder", active: false },
  { icon: BookOpen, label: "Question Bank", href: "/question-bank", active: false },
  { icon: BarChart2, label: "Analytics", href: "/analytics", active: true },
  { icon: Compass, label: "Quiz Discovery", href: "/quiz-discovery", active: true },
  { icon: TrendingUp, label: "Performance", href: "/performance", active: true },
];
