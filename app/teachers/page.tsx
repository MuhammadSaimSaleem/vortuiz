        ...
        <div className="rounded-2xl overflow-hidden bg-teal-600/80 aspect-4/3 flex items-end justify-center relative">
          ...
          <div className="absolute bottom-6 right-6 left-16 bg-white/95 rounded-xl p-3 shadow-lg">
            ...
            <div className="space-y-1.5">
              {["Transformative assessment for every classroom", "", ""].map((t, i) => (
  ...
  return (
    <div className="rounded-2xl bg-teal-600 p-5 h-full flex flex-col justify-end min-h-45">
      ...
      <div className="mt-3 rounded-lg bg-white/10 border border-white/20 p-2">
        <div className="h-1.5 bg-white/50 rounded w-3/4 mb-1" />
    ...
    <section className="max-w-6xl mx-auto px-6 py-24">
      <FadeIn className="text-center mb-14">
        ...
        <p className="text-slate-400 text-sm max-w-md mx-auto leading-relaxed">
          Built by educators, for educators. Focus on teaching while we handle the complexity of assessment management.
        </p>
      </FadeIn>

      {/* Row 1: wide card + dark card */}
      <div className="grid md:grid-cols-3 gap-5 mb-5">
        {/* Intuitive Quiz Builder — spans 2 cols */}
        <FadeIn delay={0} className="md:col-span-2 rounded-2xl border border-border bg-white p-7 flex flex-col">
          ...
          <p className="text-sm text-slate-400 leading-relaxed">
            Create complex assessments in minutes. Support for multiple-choice, open-ended, fill-in-the-blanks, and rich media questions. Drag-and-drop organization makes restructuring your curriculum effortless.
          </p>
          <QuizBuilderMockup />
        </FadeIn>

        {/* Shared Repositories — dark */}
        <FadeIn delay={100} className="rounded-2xl bg-brand-navy p-7 flex flex-col text-white">
          <div className="h-9 w-9 rounded-xl bg-white/10 flex items-center justify-center mb-5">
            <FolderOpen className="h-4 w-4 text-white" />
          </div>
          <h3 className="font-bold text-white text-base mb-2">Shared Repositories</h3>
          <p className="text-sm text-blue-200 leading-relaxed flex-1">
            Collaborate with department colleagues. Store, tag, and share question banks across your entire institution to ensure consistent quality and standards.
          </p>
        </FadeIn>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-5">
        ...
        <FadeIn delay={0} className="rounded-2xl border border-border bg-slate-50 p-7 flex flex-col">
          <div className="h-9 w-9 rounded-xl bg-white flex items-center justify-center mb-5 border border-border shadow-sm">
